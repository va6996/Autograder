...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(Loading, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(171, 171, 171))
        );
    ...
    private void submitAction(int select){
        try {
            ...
            boolean isCompiled = Compile.compile(compile);
            if(isCompiled){
                defaultText.setText("Compiled Successfully!");
                boolean correctlyExecuted = Execute.execute(execute, questionList.get(index));
